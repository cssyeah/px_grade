...
return array (
  ...
  'COM_INSTALLER_MSG_WARNINGS_JOOMLATMPNOTWRITEABLEDESC' => 'This may cause issues when trying to upload extensions to Joomla. If you are having issues uploading extensions, make sure the folder defined in your configuration.php exists or check the \'%s\' and set it to be writable and see if this fixes the issue.',
  ...
  'COM_INSTALLER_MSG_WARNINGS_PHPUPLOADNOTWRITEABLE' => 'The PHP temporary folder is not writable.',
  'COM_INSTALLER_MSG_WARNINGS_PHPUPLOADNOTWRITEABLEDESC' => 'This folder specified by <code>upload_tmp_dir</code> in your php.ini is not writable by the Joomla! instance, which may cause issues when trying to upload extensions to Joomla. If you are having issues uploading extensions, check the \'%s\' and set it to be writable and see if this fixes the issue.',
