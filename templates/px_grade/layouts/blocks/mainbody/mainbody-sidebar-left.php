...
<div id="px-mainbody-wrap" class="px-mainbody-wrap">
  <div class="container">
    <div class="row row-flex">
      <div id="px-main-content" class="px-main-content col-xs-12 col-md-8 col-lg-9">
      ...
      <div id="px-sidebar-left" class="px-sidebar px-sidebar-left col-xs-12 col-md-4 col-lg-3 order-md-first">
